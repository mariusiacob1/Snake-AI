...
Point = namedtuple('Point', 'x, y')  # x = width and y = height
...
class SnakeGameAI:
    ...
    def play_step(self, action):
        ...
        # 5. place new poison or just move
        if self.head == self.poison:
            game_over = True
            reward = -10
            return reward, game_over, self.score
    ...
    def _update_ui(self):
        ...
        pygame.draw.rect(self.display, PURPLE, pygame.Rect(self.poison.x, self.poison.y, BLOCK_SIZE, BLOCK_SIZE))
